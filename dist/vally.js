(function (global, factory) {
  ...
  var createConfig = function createConfig(specs) {
    ...
    return {
      fields: specs.reduce(function (acc, spec) {
        ...
        var isInputOrSelect = node instanceof HTMLInputElement || node instanceof HTMLSelectElement;
  ...
  var flattenFields = function flattenFields(nestedFields) {
    return nestedFields.reduce(function (acc, f) {
      var nodeDef = f.nodeDef;


      if (nodeDef instanceof Array) {
        var flattenedFields = nodeDef.map(function (node) {
          return {
            node: node,
        ...
        return [].concat(toConsumableArray(acc), toConsumableArray(flattenedFields));
      }
